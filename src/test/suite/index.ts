...
export function run(): Promise<void> {
	...
	return new Promise((c, e) => {
		...
		glob('**/{project,register_vision,register_coder,interrupt_coder,migration_guide,migration_device,migration_project}.test.js', { cwd: testsRoot }, (err: Error | null, files: string[]) => {
			if (err) {
				return e(err);
			}
