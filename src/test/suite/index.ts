...
export function run(): Promise<void> {
	...
	return new Promise((c, e) => {
		...
		glob(
			'**/{project,register_vision,register_coder,interrupt_coder,collateral_tree,migration_guide,migration_device,migration_project,migration_report,migration_syscfg}.test.js',
